//
//  MockAsyncThrowingImplementationTests.swift
//  MockedTests
//
...
final class MockAsyncThrowingImplementationTests: XCTestCase {

    // MARK: Typealiases

    typealias SUT = MockAsyncThrowingImplementation<ReturnValue>
...
extension MockAsyncThrowingImplementationTests {
