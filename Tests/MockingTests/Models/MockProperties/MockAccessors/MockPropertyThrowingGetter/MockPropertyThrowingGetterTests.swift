//
//  MockPropertyThrowingGetterTests.swift
//
...
struct MockPropertyThrowingGetterTests {

    // MARK: Typealiases

    typealias SUT = MockPropertyThrowingGetter<Value>
    typealias Value = Int
...
extension MockPropertyThrowingGetterTests {
    private func sut() -> (
        getter: SUT,
