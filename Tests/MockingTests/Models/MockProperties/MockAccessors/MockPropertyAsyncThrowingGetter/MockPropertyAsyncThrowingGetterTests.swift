//
//  MockPropertyAsyncThrowingGetterTests.swift
//
...
struct MockPropertyAsyncThrowingGetterTests {

    // MARK: Typealiases

    typealias SUT = MockPropertyAsyncThrowingGetter<Value>
    typealias Value = Int
...
extension MockPropertyAsyncThrowingGetterTests {
    private func sut() -> (
        getter: SUT,
