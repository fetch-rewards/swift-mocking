//
//  MockSubscriptAsyncGetterTests.swift
//
...
struct MockSubscriptAsyncGetterTests {

    // MARK: Typealiases

    typealias SUT = MockSubscriptAsyncGetter<Arguments, Value>
    ...
    func returnedValues() async throws {
        ...
        sut.implementation = .uncheckedInvokes { _ in 10 }
...
extension MockSubscriptAsyncGetterTests {
    private func sut() -> (
        getter: SUT,
