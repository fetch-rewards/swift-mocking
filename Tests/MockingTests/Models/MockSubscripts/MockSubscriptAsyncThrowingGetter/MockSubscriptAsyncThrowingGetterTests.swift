//
//  MockSubscriptAsyncThrowingGetterTests.swift
//
...
struct MockSubscriptAsyncThrowingGetterTests {

    // MARK: Typealiases

    typealias SUT = MockSubscriptAsyncThrowingGetter<Arguments, Value>
...
extension MockSubscriptAsyncThrowingGetterTests {
    private func sut() -> (
        getter: SUT,
