//
//  MockReadOnlyAsyncThrowingVariable+Getter.swift
//  Mockable
//
...
extension MockReadOnlyAsyncThrowingVariable {

    /// The invocation records and implementation for a read-only, async,
    /// throwing variable's getter.
    public struct Getter {
        ...
        mutating func `get`() async throws -> Value {
