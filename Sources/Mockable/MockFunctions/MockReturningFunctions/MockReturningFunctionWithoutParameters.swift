...
public final class MockReturningFunctionWithoutParameters<ReturnValue> {
    ...
    ///
    /// ```swift
    /// private let __items = MockReturningFunctionWithoutParameters<Items>.makeFunction(
    ///     description: MockImplementationDescription(
    ///         type: Self.self,
    ///         member: "_items"
    ///     )
    /// )
    /// public var _items: MockReturningFunctionWithoutParameters<Items> {
    ...
    public static func makeFunction(
        ...
        let function = MockReturningFunctionWithoutParameters(description: description)
