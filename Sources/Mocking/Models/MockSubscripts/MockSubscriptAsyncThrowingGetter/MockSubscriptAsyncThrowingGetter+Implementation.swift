//
//  MockSubscriptAsyncThrowingGetter+Implementation.swift
//
...
extension MockSubscriptAsyncThrowingGetter {

    /// An implementation for an async, throwing mock subscript getter.
    public enum Implementation: @unchecked Sendable {
        ...
        case uncheckedInvokes(_ closure: (Arguments) async throws -> Value)
        ...
        public static func invokes(
            _ closure: @Sendable @escaping (Arguments) async throws -> Value
        ...
        func callAsFunction(_ arguments: Arguments) async throws -> Value? {
            switch self {
            case .unimplemented:
                nil
